...
O código fonte completo para este exemplo (incluindo os testes unitários e de widget) pode ser encontrado [aqui](https://github.com/mit-73/Bloc/tree/master/examples/flutter_login).
