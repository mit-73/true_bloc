...
Bloc extiende [VSCode](https://code.visualstudio.com/) con soporte para [la libería Bloc](https://bloclibrary.dev) y provee herramientas para crear [Blocs](https://github.com/mit-73/bloc) y [Cubits](https://github.com/mit-73/cubit) de manera efectiva tanto para aplicaciones desarrolladas en [Flutter](https://flutter.dev/) como [AngularDart](https://angulardart.dev/).
...
![demostración](https://raw.githubusercontent.com/mit-73/bloc/master/extensions/vscode/assets/new-bloc-usage-1.gif)
...
![demostración](https://raw.githubusercontent.com/mit-73/bloc/master/extensions/vscode/assets/new-bloc-usage-2.gif)
