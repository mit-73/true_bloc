<p align="right">
<a href="https://flutter.dev/docs/development/packages-and-plugins/favorites"><img src="https://raw.githubusercontent.com/mit-73/true_bloc/master/docs/assets/flutter_favorite.png" width="100" alt="build"></a>
</p>
...
<p align="center">
<a href="https://pub.dev/packages/true_bloc"><img src="https://img.shields.io/pub/v/true_bloc.svg" alt="Pub"></a>
...
![Cubit Architecture](https://raw.githubusercontent.com/mit-73/true_bloc/master/docs/assets/cubit_architecture_full.png)
...
![Cubit Flow](https://raw.githubusercontent.com/mit-73/true_bloc/master/docs/assets/cubit_flow.png)
...
![Bloc Architecture](https://raw.githubusercontent.com/mit-73/true_bloc/master/docs/assets/bloc_architecture_full.png)

A `Bloc` is a more advanced class which relies on `events` to trigger `state` changes rather than functions. `Bloc` also extends `BlocBase` which means it has a similar public API as `Cubit`. However, rather than calling a `function` on a `Bloc` and directly emitting a new `state`, `Blocs` receive `events` and convert the incoming `events` into outgoing `states`.

![Bloc Flow](https://raw.githubusercontent.com/mit-73/true_bloc/master/docs/assets/bloc_flow.png)
...
- [Counter](https://github.com/mit-73/true_bloc/tree/master/packages/true_bloc/example) - an example of how to create a `CounterBloc` in a pure Dart app.
