...
void main() {
  group('Bloc Emitter Tests', () {
    group('Simple Bloc', () {
      ...
      test('state returns correct value after emitter', () {
        simpleBloc.test();
        expect(simpleBloc.state, 'test');
      });
    });
    ...
    group('Complex Bloc', () {
      ...
      test('state returns correct value after emitter', () {
        complexBloc.setStateA();
        expect(complexBloc.state, ComplexStateA());

        complexBloc.setStateB();
        expect(complexBloc.state, ComplexStateB());
      });
    });
